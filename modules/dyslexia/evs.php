...
<style>
  ...
  .hero {
    ...
    width:100%;
    height:100vh;
    background: url('../../kids/evsbg.jpg') center/cover no-repeat;
    display:flex;
...
<div class="hero">
  ...
  <!-- Main overlay -->
  <div class="overlay">
    <h1 class="title">Environmental Studies</h1>
    <p class="subtitle">“Learn about My Body, Plants, and Animals in a fun way ”</p>

    <div class="buttons">
      <a href="learnevs.php" class="btn btn-green">📊 Learn</a>
      <a href="evsgames.php" class="btn btn-red">🧠  Games</a>
    </div>
  </div>
</div>
