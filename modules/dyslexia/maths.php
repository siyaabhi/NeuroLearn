...
<style>
  ...
  .hero {
    ...
    width:100%;
    height:100vh;
    background: url('../../kids/dyslexiamaths.jpg') center/cover no-repeat;
    display:flex;
...
<div class="hero">
  ...
  <!-- Main overlay -->
  <div class="overlay">
    <h1 class="title">MATHS 🔢</h1>
    <p class="subtitle">“Mathematics is the sense you never knew you had, and kids can see it. Let’s make numbers your friends!”</p>

    <div class="buttons">
      <a href="learnmaths.php" class="btn btn-red">📊 Learn Maths</a>
      <a href="mathsgames.php" class="btn btn-blue">🧠 Math Games</a>
    </div>
  </div>
</div>
